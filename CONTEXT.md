...
**Role**:
A paid employment position (e.g. Insyght, Offroad, Altix, Huawei). The primary unit of evidence on the site.
...
**Metric**:
A quantified proof point attached to a Role (e.g. "960 → 189 µA idle", "92% classifier @ 40 KB"). The site's strongest evidence and a load-bearing part of the aesthetic, not decoration.
_Avoid_: Stat, Highlight, Badge

**Case study**:
The detail page for a single Project (context, role, stack, prose, visuals).
_Avoid_: Write-up, Project page
